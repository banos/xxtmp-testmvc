...
(function(undefined) {
        ...
        var Map = can.Map = can.Construct.extend({
...

            {
                ...
                __set: function(prop, value, current) {
                    ...
                    // TOBUY: Check if value is object and transform
    ...
    var __m21 = (function(can) {
        ...
        // TOBUY: this doesn't seem to be doing anything
                    ...
                    if (startTag === null) {
                        switch (token) {
                            ...
                            case '>':
                                ...
                                // TOBUY: we should only add `can.EJS.pending()` if there's a magic tag
        ...
        var live = {
            ...
            html: function(el, compute, parentNode) {
                ...
                data = listen(parentNode, compute, function(ev, newVal, oldVal) {
                    // TOBUY: remove teardownCheck in 2.1
    ...
    var __m22 = (function(can, elements, live) {
        ...
        can.extend(can.view, {
                ...
                pending: function(data) {
                    // TOBUY, make this only run for the right tagName
                    var hooks = can.view.getHooks();
                    return can.view.hook(function(el) {
                        can.each(hooks, function(fn) {
                            fn(el);
                ...
                txt: function(escape, tagName, status, self, func) {
                    ...
                    if (withinTemplatedSectionWithinAnElement) {
                        ...
                        // TOBUY: the scanner should be able to set this up.
