  ...
  */
  ...
  blocks.extend(blocks, {
    ...
    toString: function(value) {
      // TOBUY: Implement and make tests
      var result = '';
    ...
    toArray: function(value) {
      // TOBUY: Think if it should be removed permanantely.
      ...
      if (blocks.isElements(value)) {
        // TOBUY: if not IE8 and below use slice.call
        /* jshint newcap: false */
    ...
    equals: function(a, b, deepEqual) {
      // TOBUY: deepEqual could accept a Number which represents the levels it could go in the recursion
      a = blocks.unwrap(a);
      b = blocks.unwrap(b);
...
// TOBUY: ifNeedsResult could be removed and automatically detect if you need to include the this.result in the descriptor string
...
// TOBUY: reduceRight and lastIndexOf are equal to code as reduce and indexOf respectivly
...
return result;
  ...
  */
  ...
  blocks.core.applyExpressions = function (expressionName, object, methods) {
    // TOBUY: Removed when all expresions are implemented
...
(function () {
    ...
    comment: {
      ...
      attr: function (element, attributeName, attributeValue) {
        if (element && attributeName == dataIdAttr && attributeValue) {
          var commentElement = element;
          // TOBUY: This should be refactored
...

 {
          ...
          if (VirtualComment.Is(element) && !method.supportsComments) {
            // TOBUY: Should throw debug message
            continue;
          }
  ...
  function createCache(query, element) {
    ...
    parseQuery(query, function (methodName, parameters) {
      ...
      if (method) {
        // TOBUY: Think of a way to remove this approach
    ...
    render: {
      ...
      update: function (condition) {
        ...
        if (elementData.renderCache && condition.value) {
          // TOBUY: Should use the logic from dom.html method
      ...
      array: {
        ...
        sort: function (sortfunction) {
          ...
          for (; i < length; i++) {
            ...
            //if (!useSortFunction) { // TOBUY: Test performance
          ...
          // TOBUY: Test performance (Comment)
          array.sort(function (a, b) {
            a = a[0];
            b = b[0];
            if (useSortFunction) {
  ...
  */
  ...
  Model.prototype = {
    ...
    read: function (params, callback) {
      // TOBUY: Write tests for the callback checking if it is beeing called
  ...
  */
  ...
  blocks.observable.fn.collection = {
     ...
     */
    read: function (params, callback) {
      // TOBUY: Write tests for the callback checking if it is being called
      var _this = this;
    ...
    // TOBUY: Add a test which adds to the center of the collection or the start
  ...
  Application.prototype = {
    ...
    */
    ...
    View: function (name, prototype, nestedViewPrototype) {
      // TOBUY: Validate prototype by checking if a property does not override a proto method
        ...
        for (; i < viewPrototypePairs.length; i++) {
          ...
          if (parentViewName) {
            ...
            if (!this._viewPrototypes[parentViewName]) {
              ...
              //TOBUY: Throw critical error parentView with such name does not exists
            }
            //#endregion
