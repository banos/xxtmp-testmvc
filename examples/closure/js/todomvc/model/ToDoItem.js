goog.provide('tobuymvc.model.ToDoItem');

/**
 * The model object representing a tobuy item.
 *
 ...
 * @constructor
 */
tobuymvc.model.ToDoItem = function(note, opt_done, opt_id) {
    /**
 ...
 */
tobuymvc.model.ToDoItem.prototype.getNote = function() {
    return this.note_;
};
 ...
 */
tobuymvc.model.ToDoItem.prototype.isDone = function() {
    return this.done_;
};
 ...
 */
tobuymvc.model.ToDoItem.prototype.getId = function() {
    return this.id_;
};
 ...
 * @param {!string} note the text associated with this item.
 */
tobuymvc.model.ToDoItem.prototype.setNote = function(note) {
    this.note_ = note;
};
 ...
 */
tobuymvc.model.ToDoItem.prototype.setDone = function(done) {
    this.done_ = done;
};
 ...
 */
tobuymvc.model.ToDoItem.prototype.setId = function(id) {
    this.id_ = id;
};
