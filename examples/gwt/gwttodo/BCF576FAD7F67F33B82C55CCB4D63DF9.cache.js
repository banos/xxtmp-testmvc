(function(){var $gwt_version = "2.6.0";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $strongName = 'BCF576FAD7F67F33B82C55CCB4D63DF9';var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;var $sessionId = $wnd.__gwtStatsSessionId ? $wnd.__gwtStatsSessionId : null;$stats && $stats({moduleName:'gwttobuy',sessionId:$sessionId,subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});function V(){}
function BE(){}
function ab(){}
function vc(){}
function Mc(){}
...
function _x(){this.n=new cq(new ax);Lo(this,jy(new ky(this)));ap(this.n,(lr(),jr));gd(this.c,'main');gd((Dr(),this.a.u),'clear-completed');gd(this.j.u,'new-tobuy');gd(this.k,'footer');gd(this.o,'toggle-all')}
...
function ty(a,b,c,d,e,f,g,h,i,j,k){var l;l=new qA;Rc(l.a,"<section id='tobuyapp'> <header id='header'> <h1>tobuys<\/h1> <span id='");pA(l,Cn(a));Rc(l.a,"'><\/span> <\/header> <section id='");pA(l,Cn(b));Rc(l.a,"'> <input id='");pA(l,Cn(c));Rc(l.a,"' type='checkbox'> <label for='toggle-all'>Mark all as complete<\/label> <div id='tobuy-list'> <span id='");pA(l,Cn(d));Rc(l.a,"'><\/span> <\/div> <\/section> <footer id='");pA(l,Cn(e));Rc(l.a,"'> <span id='tobuy-count'> <strong class='number' id='");pA(l,Cn(f));Rc(l.a,"'><\/strong> <span class='word' id='");pA(l,Cn(g));Rc(l.a,"'><\/span> left <\/span> <ul id='filters'> <li> <span id='");pA(l,Cn(h));Rc(l.a,nG);pA(l,Cn(i));Rc(l.a,nG);pA(l,Cn(j));Rc(l.a,"'><\/span> <\/li> <\/ul> <span id='");pA(l,Cn(k));Rc(l.a,"'><\/span> <\/footer> <\/section> <footer id='info'> <p>Double-click to edit a tobuy<\/p> <p>Created by <a href='http://www.scottlogic.co.uk/blog/colin/'>Colin Eberhardt<\/a><\/p> <p>Part of <a href='http://tobuymvc.com'>TodoMVC<\/a><\/p> <\/footer>");return new jn(l.a.a)}
