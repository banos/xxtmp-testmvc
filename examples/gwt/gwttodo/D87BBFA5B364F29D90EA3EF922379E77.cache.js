...
function Tx(){this.o=new Lp(new Uw);to(this,by(new cy(this)));Ko(this.o,(Uq(),Sq));Sc(this.d,'main');Sc((kr(),this.b.v),'clear-completed');Sc(this.k.v,'new-tobuy');Sc(this.n,'footer');Sc(this.p,'toggle-all')}
...
function ly(a,b,c,d,e,f,g,h,i,j,k){var l;l=new iA;Bc(l.b,"<section id='tobuyapp'> <header id='header'> <h1>tobuys<\/h1> <span id='");hA(l,kn(a));Bc(l.b,"'><\/span> <\/header> <section id='");hA(l,kn(b));Bc(l.b,"'> <input id='");hA(l,kn(c));Bc(l.b,"' type='checkbox'> <label for='toggle-all'>Mark all as complete<\/label> <div id='tobuy-list'> <span id='");hA(l,kn(d));Bc(l.b,"'><\/span> <\/div> <\/section> <footer id='");hA(l,kn(e));Bc(l.b,"'> <span id='tobuy-count'> <strong class='number' id='");hA(l,kn(f));Bc(l.b,"'><\/strong> <span class='word' id='");hA(l,kn(g));Bc(l.b,"'><\/span> left <\/span> <ul id='filters'> <li> <span id='");hA(l,kn(h));Bc(l.b,iG);hA(l,kn(i));Bc(l.b,iG);hA(l,kn(j));Bc(l.b,"'><\/span> <\/li> <\/ul> <span id='");hA(l,kn(k));Bc(l.b,"'><\/span> <\/footer> <\/section> <footer id='info'> <p>Double-click to edit a tobuy<\/p> <p>Created by <a href='http://www.scottlogic.co.uk/blog/colin/'>Colin Eberhardt<\/a><\/p> <p>Part of <a href='http://tobuymvc.com'>TodoMVC<\/a><\/p> <\/footer>");return new Sm(l.b.b)}
