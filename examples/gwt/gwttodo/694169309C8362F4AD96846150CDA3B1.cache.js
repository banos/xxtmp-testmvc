...
function Ly(){this.o=new Gq(new Mx);np(this,Vy(new Wy(this)));Ep(this.o,(Pr(),Nr));Ed(this.d,'main');Ed((fs(),this.b.v),'clear-completed');Ed(this.k.v,'new-tobuy');Ed(this.n,'footer');Ed(this.p,'toggle-all')}
...
function dz(a,b,c,d,e,f,g,h,i,j,k){var l;l=new gB;nd(l.b,"<section id='tobuyapp'> <header id='header'> <h1>tobuys<\/h1> <span id='");fB(l,fo(a));nd(l.b,"'><\/span> <\/header> <section id='");fB(l,fo(b));nd(l.b,"'> <input id='");fB(l,fo(c));nd(l.b,"' type='checkbox'> <label for='toggle-all'>Mark all as complete<\/label> <div id='tobuy-list'> <span id='");fB(l,fo(d));nd(l.b,"'><\/span> <\/div> <\/section> <footer id='");fB(l,fo(e));nd(l.b,"'> <span id='tobuy-count'> <strong class='number' id='");fB(l,fo(f));nd(l.b,"'><\/strong> <span class='word' id='");fB(l,fo(g));nd(l.b,"'><\/span> left <\/span> <ul id='filters'> <li> <span id='");fB(l,fo(h));nd(l.b,hH);fB(l,fo(i));nd(l.b,hH);fB(l,fo(j));nd(l.b,"'><\/span> <\/li> <\/ul> <span id='");fB(l,fo(k));nd(l.b,"'><\/span> <\/footer> <\/section> <footer id='info'> <p>Double-click to edit a tobuy<\/p> <p>Created by <a href='http://www.scottlogic.co.uk/blog/colin/'>Colin Eberhardt<\/a><\/p> <p>Part of <a href='http://tobuymvc.com'>TodoMVC<\/a><\/p> <\/footer>");return new Nn(l.b.b)}
