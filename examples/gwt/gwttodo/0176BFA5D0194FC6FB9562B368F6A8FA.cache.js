(function(){var $gwt_version = "2.6.0";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $strongName = '0176BFA5D0194FC6FB9562B368F6A8FA';var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;var $sessionId = $wnd.__gwtStatsSessionId ? $wnd.__gwtStatsSessionId : null;$stats && $stats({moduleName:'gwttobuy',sessionId:$sessionId,subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});function V(){}
function LE(){}
function ab(){}
function ag(){}
function Sg(){}
...
function fy(){this.n=new qq(new gx);Mo(this,py(new qy(this)));bp(this.n,(zr(),xr));gd(this.c,'main');gd((Rr(),this.a.u),'clear-completed');gd(this.j.u,'new-tobuy');gd(this.k,'footer');gd(this.o,'toggle-all')}
...
function zy(a,b,c,d,e,f,g,h,i,j,k){var l;l=new AA;Rc(l.a,"<section id='tobuyapp'> <header id='header'> <h1>tobuys<\/h1> <span id='");zA(l,En(a));Rc(l.a,"'><\/span> <\/header> <section id='");zA(l,En(b));Rc(l.a,"'> <input id='");zA(l,En(c));Rc(l.a,"' type='checkbox'> <label for='toggle-all'>Mark all as complete<\/label> <div id='tobuy-list'> <span id='");zA(l,En(d));Rc(l.a,"'><\/span> <\/div> <\/section> <footer id='");zA(l,En(e));Rc(l.a,"'> <span id='tobuy-count'> <strong class='number' id='");zA(l,En(f));Rc(l.a,"'><\/strong> <span class='word' id='");zA(l,En(g));Rc(l.a,"'><\/span> left <\/span> <ul id='filters'> <li> <span id='");zA(l,En(h));Rc(l.a,IG);zA(l,En(i));Rc(l.a,IG);zA(l,En(j));Rc(l.a,"'><\/span> <\/li> <\/ul> <span id='");zA(l,En(k));Rc(l.a,"'><\/span> <\/footer> <\/section> <footer id='info'> <p>Double-click to edit a tobuy<\/p> <p>Created by <a href='http://www.scottlogic.co.uk/blog/colin/'>Colin Eberhardt<\/a><\/p> <p>Part of <a href='http://tobuymvc.com'>TodoMVC<\/a><\/p> <\/footer>");return new ln(l.a.a)}
