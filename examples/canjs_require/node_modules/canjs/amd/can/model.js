...
define(["can/util/library", "can/map", "can/list"], function (can) {
	...
	can.Model = can.Map({
		 ...
		 */
		{
			 ...
			 *     var tobuy = new Todo({name: "dishes"})
			 *
			 ...
			 *     Todo.findOne({id: 5},function(tobuy){
			 *
	...
	can.each({
		 ...
		 *     },{})
		 *
		 * The following Todo model will never request the same list of tobuy's twice:
		 *
		 *     Todo = CachedModel({
		 *       findAll: "/tobuys"
		 *     },{})
		 ...
		 *     },{})
		 *
		 * The following Todo model will never request the same tobuy twice:
		 *
		 *     Todo = CachedModel({
		 *       findOne: "/tobuys/{id}"
		 *     },{})
